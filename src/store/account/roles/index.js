...
export function sync(orgId, accountId) {
  return (dispatch) => {
    ...
    return watchValue(`state/permissions/grantedTo/accountLevel/${orgId}/${accountId}`, (data, paths) => {
...
export function clear() {
  return (dispatch, getState) => {
    removeListeners(getState().account.roles.data.paths);
