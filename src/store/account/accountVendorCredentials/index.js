...
const namespace = 'ACCOUNTVENDORCREDENTIALS';
...
export function sync(organizationId, accountId) {
  return (dispatch) => {
    ...
    return watchValue(`state/accountVendorCredentials/${organizationId}/${accountId}`, (item, paths) => {
...
export function set(organizationId, accountId, id, data) {
  return (dispatch) => {
    dispatch({ type: actionTypes.updateStart });
    return AccountsAPI.setAccountVendorCredentials(organizationId, accountId, id, data)
    .then(() => {
