...
const namespace = 'EXPENSEREPORTAPPROVALS';
...
export function sync(organizationId, accountId) {
  return (dispatch) => {
    ...
    return watchCollection(`state/expenseReportApprovals/${organizationId}/${accountId}`, (items, paths) => {
...
export function clear() {
  return (dispatch, getState) => {
    removeListeners(getState().account.expenseReportApprovals.data.paths);
...
export function create(organizationId, accountId, data) {
  return (dispatch) => {
    ...
    return ExpensesAPI.createExpenseReportApproval(organizationId, accountId, data)
    .then((res) => {
...
export function update(organizationId, accountId, id, data) {
  return (dispatch) => {
    ...
    return ExpensesAPI.updateExpenseReportApproval(organizationId, accountId, id, data)
    .then(() => {
