...
const mapDispatchToProps = (dispatch, props) => {
  return ({
    ...
    openReportScheduleModal: (columns, renderColumns, orderBy) => {
      dispatch(Store.router.openModal('Components.modals.reportschedule', { type: 'ac28', columns, renderColumns, orderBy, exports: 'generic', schedule: 'daily', uniqueExportFormat: { generic: { display: 'Comdata TXT' } } }));
    },
    clearTransactions: () => {
...
class components_reports_ac28 extends Component {
  ...
  state = {
    ...
    selectedColumns: [
      ...
      { dataField: 'Process Time', type: 'Char' },
      { dataField: 'Cleared Amount', type: 'Num' },
      { dataField: 'Virtual Card Invoice Number', type: 'Char' }, // ps20 column 33
      { dataField: 'Credit/Debit Indicator', type: 'Char' },
      { dataField: 'GL Code', type: 'Char' },
      { dataField: 'Repair Order Number', type: 'Char' }, // ps20 column 36
      { dataField: 'Vehicle Number', type: 'Char' }, // ps20 column 37
      { dataField: 'Prompted Driver ID', type: 'Char' }, // ps20 column 38
      { dataField: 'Card Token Number', type: 'Num' },
      { dataField: 'AP Response File Batch Number', type: 'Char' },
    ],
    renderedColumns: [
      ...
      { dataField: 'Match Id', text: 'Match Id', type: 'Char' },
      ...
      { dataField: 'Transaction Time', text: 'Transaction Time', type: 'Char' },
      { dataField: 'Process Date', text: 'Process Date', type: 'Char' },
      { dataField: 'Process Time', text: 'Process Time', type: 'Char' },
      { dataField: 'Cleared Amount', text: 'Cleared Amount', type: 'Cur' },
      { dataField: 'Virtual Card Invoice Number', text: 'Virtual Card Invoice Number', type: 'Char' },
      { dataField: 'Credit/Debit Indicator', text: 'Credit/Debit Indicator', type: 'Char' },
      { dataField: 'GL Code', text: 'GL Code', type: 'Char' },
      { dataField: 'Repair Order Number', text: 'Repair Order Number', type: 'Char' },
      { dataField: 'Vehicle Number', text: 'Vehicle Number', type: 'Char' },
      { dataField: 'Prompted Driver ID', text: 'Prompted Driver ID', type: 'Char' },
      { dataField: 'Card Token Number', text: 'Card Token Number', type: 'Num' },
      { dataField: 'AP Response File Batch Number', text: 'AP Response File Batch Number', type: 'Num' },
    ],
    actions: ['Schedule'],
  };
...
export default connect(mapStateToProps, mapDispatchToProps, mapResourcesToProps)(components_reports_ac28);
