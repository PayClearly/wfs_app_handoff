...
class components_uploaders_components_paymentsaggregation extends Component {
  ...
  state = {
    types: [{
      ...
      type: 'concierge',
      icon: 'headset',
      text: 'Concierge Payments',
    }, {
      type: 'notReady',
      icon: 'alert-circle',
      text: 'Payments Not Ready',
    }, {
      type: 'commission',
  ...
  render() {
    ...
    return (
      <div className="components_uploaders_components_paymentsaggregation">
        <div>
          {
...
export default connect(mapStateToProps, mapDispatchToProps)(components_uploaders_components_paymentsaggregation);
