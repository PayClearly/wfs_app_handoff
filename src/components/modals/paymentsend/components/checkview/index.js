...
class components_modals_paymentsend_components_checkview extends Component {
  ...
  render() {
    ...
    const disableButtons = this.props.paymentStatuses.status.updating || this.props.uspsStatus.fetching || this.props.uspsStatus.fetchingError;
                ...
                <div className={'row'}>
                  <div className={'col-12'}>
                    <div className="alert alert-warning" role="alert">
                      This account is not currently enrolled in automated check payments. To enroll please click {<a href={'http://localhost:5005/account/?tab=payment'}>here</a>}.
