...
class components_forms_verifymicrodeposits extends Component {

  state = {
    name: 'Components.forms.verifymicrodeposits',
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(components_forms_verifymicrodeposits);
