...
class components_ionic_forms_login extends Component {
  state = {
    name: 'Components.ionic.forms.login',
  };
  ...
  render() {
    ...
    return (
      <form className="components_ionic_forms_login ion-margin" onSubmit={this.props.onSubmit}>
...
export default connect(mapStateToProps, mapDispatchToProps, mapResourcesToProps)(components_ionic_forms_login);
